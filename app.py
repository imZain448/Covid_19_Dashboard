...
# fig 1 -- orthographic map ##############################################################
# preparing the hovertext 
...
# creating the slider for reorientation
sliders = []
frames = []
...
sliders.append(
    dict(
        active=0,
        currentvalue={"prefix": "Rotate along Longitude: "},
        pad={"t": 0},
        steps=[{
            'method': 'relayout',
            'label': str(i),
...
# fig - 8 -- top 10 countires recovery ###################################################
...
# (optional) fig -- 9 -- top 10 countries data table  #######################################
...
app.layout = html.Div([
        ...
        html.Div([
            ...
            html.Div([
                dcc.Graph(id = 'fig_7' , figure = fig_7)
            ], className = 'four columns'),
            html.Div([
                dcc.Graph(id = 'fig_8' , figure = fig_8)
            ], className = 'four columns')
        ], className = 'row'),
        html.Div([
            html.Div([
                html.H4(children = 'CURRENT STATS TOP 20 COUNTRIES' , style = {'color':'#d486f0' , 'backgroundColor':"#18191c"}),
                generate_table(df_table , max_rows=20)
            ], className = 'container')
        ] , className = 'row'),
        html.Div([
            html.Div([
